	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 text-center">
				<h1>Search</h1>
				<h4>Find your perfect Job or Candidat</h4>
			</div>
		</div>
	</div>
	</section>
			...
			<div class="col-sm-8">
				...
				<div class="jobs">
					...
					<c:forEach var="candidat" items="${candidats}">
						<a href="candidat?id=${candidat.idUtilisateur }">
							<div class="featured"></div> <img src="images/job1.jpg" alt=""
							class="img-circle" />
							<div class="title">
								<h5>${candidat.nom},${candidat.prenom}</h5>
								<p>${candidat.specialites}</p>
							</div>
							<div class="data">
								<span class="city"><i class="fa fa-map-marker"></i>${candidat.ville}</span>
